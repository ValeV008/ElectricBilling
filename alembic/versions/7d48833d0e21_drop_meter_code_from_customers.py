...
def downgrade():
    ...
    sa.UniqueConstraint('meter_code', name='customers_meter_code_key', postgresql_include=[], postgresql_nulls_not_distinct=False),
    ...
    sa.Column('total_eur', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    ...
    sa.Column('price_eur_per_kwh', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['customer_id'], ['customers.id'], name=op.f('consumption_records_customer_id_fkey')),
